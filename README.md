...
Все настройки встроены в скрипт и имеют разумные значения по умолчанию:

- **TCP сканирование**: `probe_timeout: 5`, `web_timeout: 10`
- **Веб-скриншоты**: `viewport_width: 1280`, `viewport_height: 720`, `max_browsers: 3`
- **Логирование**: `log_level: "INFO"`, `log_file: "scanner.log"`

Для изменения настроек отредактируйте класс `Config` в файле `web.py`.
...
- **Веб-скриншоты**: `./web/<ip>/<порт>.png`
  ...
  - IP Phone Web (10000)
  - IP Camera Web (8000)
  - Dahua Camera Web (37777, 37778)
- **Логи**: `scanner.log`

## Особенности

1. **Логирование**: Структурированное логирование с файлом и консолью
2. **Конфигурация**: Встроенные настройки с разумными значениями по умолчанию
...
9. **Расширенные скриншоты**: Автоматические скриншоты для всех веб-портов включая IP телефоны и камеры
